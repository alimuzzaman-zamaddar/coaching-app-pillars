...
const LandingPage = () => {
  return (
    <div className="container mx-auto">
      <section className="relative h-screen w-full rounded-[40px] overflow-hidden text-white my-5">
        {/* Background Image */}
        <div
        ...
        <div className="relative z-20 h-full grid items-end pb-[60px] sm:pb-[80px] md:pb-[100px] px-4 sm:px-6 md:px-10 lg:px-20">
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-10 md:gap-8 w-full">
            ...
            <div className="flex flex-wrap justify-start xl:justify-end items-start xl:items-end gap-4">
              ...
              <Link
                to="/download/android"
                className="flex justify-center items-center gap-2 sm:gap-3 px-8 py-2 lg:px-12 lg:py-2 xl:px-14 xl:py-3 2xl:px-16 2xl:py-4 3xl:px-18 3xl:py-5  4xl:px-20 4xl:py-6 bg-white text-black rounded-[20px] shadow-md  transition text-[12px] md:text-[14px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px] 3xl:text-[22px] 4xl:text-[24px] hover:bg-black hover:text-white duration-500"
              >
             ...
             transition duration-500 text-[12px] md:text-[14px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px] 3xl:text-[22px] 4xl:text-[24px]"
              >
